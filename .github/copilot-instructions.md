# Foundrr — setup guide for GitHub Copilot

GitHub Copilot auto-reads `.github/copilot-instructions.md` as repo-wide custom
instructions. This file tells you how to set up **Foundrr**.
